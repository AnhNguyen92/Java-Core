...
public class LexicographicallySmallestEquivalentString {
	public static void main(String[] args) {
		LexicographicallySmallestEquivalentString app = new LexicographicallySmallestEquivalentString();
		// String s1 = "parker", s2 = "morris", baseStr = "parser"; // ok
		...
		System.out.println(app.smallestEquivalentString(s1, s2, baseStr));
	}
