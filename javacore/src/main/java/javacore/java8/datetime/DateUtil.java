package javacore.java8.datetime;
...
public class DateUtil {
	...
	public static void main(String[] args) {
		String shortDate = format(LocalDate.now(), "yyyy-M-d");
        logger.info("{}", shortDate);
		logger.info("{}", getMillisecond());
		logger.info("{}", getLastSundayByMonthAndWeek(Month.OCTOBER, DayOfWeek.SUNDAY));
	}
	...
	public static LocalDate getLastSundayByMonthAndWeek(Month month, DayOfWeek dayOfWeek) {
